...
def plot_spectrum_with_error_bands(segment_duration_ms, max_plot_freq_Hz, spectra, freqs, num_segments, smoothing_length, plot_pms, title_preamble_string):
...
def compute_spectrum_with_error_bands(data, analysis_pms, max_plot_freq_Hz, smoothing_length, plot_pms, title_preamble_string):
    ...
    plot_spectrum_with_error_bands(segment_duration_ms, max_plot_freq_Hz, spectra, fft_freq, num_segments, smoothing_length, plot_pms, title_preamble_string)
